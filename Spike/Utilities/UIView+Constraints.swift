...
extension UIView {
    ...
    @discardableResult
    func dimensions(widthAnchor: NSLayoutDimension? = nil, heightAnchor: NSLayoutDimension? = nil, widthMultiplier: CGFloat = 1.0, heightMultiplier: CGFloat = 1.0) -> AnchoredConstraints {
        
        translatesAutoresizingMaskIntoConstraints = false
        var anchoredConstraints = AnchoredConstraints()
        if let widthAnchor = widthAnchor {
            anchoredConstraints.width = self.widthAnchor.constraint(equalTo: widthAnchor, multiplier: widthMultiplier)
        }
        if let heightAnchor = heightAnchor {
            anchoredConstraints.height = self.heightAnchor.constraint(equalTo: heightAnchor, multiplier: heightMultiplier)
        }
    ...
    @discardableResult
    func dimensions(withSize size: CGSize) -> AnchoredConstraints {
